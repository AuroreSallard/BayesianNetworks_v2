...
data_folder = '/nas/asallard/BN/Data/2015/data/'
USE_DETAILED_ACTIVITIES = False

households = pd.read_csv(
    data_folder + 'households0109.csv', encoding="latin1")

persons = pd.read_csv(
    data_folder + 'persons0109.csv', encoding="latin1")

target_persons = pd.read_csv(
    data_folder + 'target_persons0109.csv', encoding="latin1")

wege = pd.read_csv(
    data_folder + 'wege0109.csv', encoding="latin1")
...
data4bn.to_csv(data_folder + 'data4bn_2015.csv', na_rep = 'NA', index = False,
               index_label=False)
