...
data_folder = '/nas/asallard/BN/Data/2005/data/'
USE_DETAILED_ACTIVITIES = False

households = pd.read_csv(
    data_folder + 'households2005.csv', encoding="latin1")

persons = pd.read_csv(
    data_folder + 'persons2005.csv', encoding="latin1")

target_persons = pd.read_csv(
    data_folder + 'target_persons2005.csv', encoding="latin1")

wege = pd.read_csv(
    data_folder + 'wege2005.csv', encoding="latin1")
...
target_persons_cols = [
    ...
    'Car_available', 'Motorcycle_available', 'age_class', 'Marital_status', "Person_id", "age_class9"
]
...
data4bn.to_csv(data_folder + 'data4bn_2005.csv', na_rep = 'NA', index = False,
               index_label=False)
