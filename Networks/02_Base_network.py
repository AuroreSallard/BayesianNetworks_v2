...
# Import data, extract weights. Impossible to use 21 activities so we can restrict the study to XX activities.
...
model.plot("/nas/asallard/BN/Results/010921/Net_9act_income.pdf")
...
df_sampled.to_csv("/nas/asallard/BN/Results/010921/Net_9act_income.csv")
