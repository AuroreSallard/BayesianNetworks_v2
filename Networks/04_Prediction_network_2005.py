...
df = pd.read_csv("/nas/asallard/BN/Data/2005/data/data4bn_2005.csv")
df = df[df["activity10"] == "stop"]
#df = df[np.logical_and(df["Week_day"] != "Saturday", df["Week_day"] != "Sunday")]

colnames = ["canton", "hhtype", "household_size_class", "municipality_type", "Work_time", "Sex", "Language","age_class", "Marital_status", "nb_bikes", "nb_cars", "Week_day"] + ["activity"+str(k) for k in range(1,10)]
...
sociodem_nodes_indices = range(11)
socioday_nodes_indices = range(12)
activities_nodes_indices = range(12, 32)
...
model.plot("/nas/asallard/BN/Results/21_09_07/Net_9act_2005.pdf")
...
df_sampled.to_csv("/nas/asallard/BN/Results/21_09_07/Net_9act_2005.csv")
